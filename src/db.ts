/**
 * SQLite database access layer for the Finnish Energy Regulation MCP server.
 *
 * Schema covers four Finnish energy regulators:
 *   - regulations      — Energiavirasto decisions, TEM energy policy, Tukes safety rules
 *   - grid_codes       — Fingrid grid codes, balancing rules, Datahub requirements
 *   - decisions        — Energiavirasto network pricing decisions, market supervision rulings
 *
